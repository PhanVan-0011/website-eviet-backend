    ...
    public function run(): void
    {
        ...
        $posts = [
            [
                ...
                'status' => true,
                'image_url' => 'https://example.com/images/ca-phe-bai-viet.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'status' => true,
                'image_url' => 'https://example.com/images/trai-cay-bai-viet.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'status' => true,
                'image_url' => 'https://example.com/images/an-vat-bai-viet.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
        ];
